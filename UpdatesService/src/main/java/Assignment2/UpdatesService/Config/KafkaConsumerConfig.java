...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, EmpRequest> consumerFactory(){
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, EmployeeRequestSerializerDeserializer.class);
        return new DefaultKafkaConsumerFactory<>(props);

    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String,EmpRequest> kafkaListenerContainerFactory(){
        ConcurrentKafkaListenerContainerFactory<String,EmpRequest> factory=new ConcurrentKafkaListenerContainerFactory<>();
